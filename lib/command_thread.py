...
def _make_text_safeish(text, fallback_encoding):
    ...
    try:
        ...
        unitext = text.encode(fallback_encoding)
    return unitext
...
class CommandThread(threading.Thread):
    ...
    def run(self):
        ...
        try:
            ...
            proc = subprocess.Popen(self.command, stdout=subprocess.PIPE, stderr=subprocess.STDOUT, shell=shell, universal_newlines=True, env=self.env)
